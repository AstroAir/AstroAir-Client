...
function GeocentricCoordinates (day)     // this function is used for most celestial bodies (but not the Moon)
{
...
function EclipticAngularCoordinates (day)
{
...
function HorizontalCoordinates (day, location)
{
